...
export const INITIAL_FIXTURES = Object.fromEntries(
  Object.keys(FIXTURE_TYPE).map(id => [id, false])
);

export default function LoaderView({ fixtures, headlight, toggleFixture, cycleHeadlight, onHomeClick, style }) {
  ...
  return (
    ...
    >
      ...
      {/* Home button — returns to the dashboard view (bottom-center) */}
      <g
        id="loader-home-button"
        onClick={onHomeClick}
        style={{ cursor: 'pointer' }}
      >
        <rect className="home-bg" x="414" y="362" width="92" height="28" rx="5" fill="#13171d" stroke="#2a3a48" strokeWidth="1"/>
        <g transform="translate(424, 370)" pointerEvents="none">
          <path d="M 0 8 L 7 1 L 14 8 L 14 14 L 9 14 L 9 10 L 5 10 L 5 14 L 0 14 Z" fill="none" stroke="#c8dce8" strokeWidth="1.5" strokeLinejoin="round"/>
        </g>
        <text x="446" y="380" fontFamily="Share Tech Mono,monospace" fontSize="10" letterSpacing="1.5" fill="#c8dce8" pointerEvents="none">DASHBOARD</text>
      </g>
    </svg>
  );
}
